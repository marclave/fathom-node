...
This is a generated TypeScript SDK for Fathom Analytics API, produced by the Scalar SDK Generator (https://scalar.com).
...
If the issue is in the Fathom Analytics API or service rather than in this SDK, report it through the security process Fathom Analytics API has published.
