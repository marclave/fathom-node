...
import { Sites, type SiteListParams, type SiteCreateParams, type SiteUpdateParams } from './resources/sites';
import {
  Events,
  type EventListParams,
  type EventDeleteByNameParams,
  type EventCreateParams,
  type EventSetCurrencyParams,
  type EventRetrieveParams,
  type EventUpdateParams,
  type EventDeleteParams,
  type EventWipeParams,
} from './resources/events';
import {
  Milestones,
  type MilestoneListParams,
  type MilestoneCreateParams,
  type MilestoneRetrieveParams,
  type MilestoneUpdateParams,
  type MilestoneDeleteParams,
} from './resources/milestones';
import { Reports, type ReportAggregationParams, type ReportCurrentVisitorsParams } from './resources/reports';
...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env["FATHOM_BASE_URL"].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env["FATHOM_LOG"] or 'warn' if it isn't set.
   */
...
export class fathom {
   ...
   * @param {string} [opts.baseURL=process.env["FATHOM_BASE_URL"] ?? https://api.usefathom.com/v1] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('FATHOM_BASE_URL'),
    ...
    const options: ClientOptions = {
      bearerAuth,
      ...opts,
      baseURL: baseURL || 'https://api.usefathom.com/v1',
    };
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('FATHOM_LOG'), 'process.env["FATHOM_LOG"]', this) ??
      defaultLogLevel;
    ...
    const customHeadersEnv = readEnv('FATHOM_CUSTOM_HEADERS');
    if (customHeadersEnv) {
